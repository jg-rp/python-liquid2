...
| IntegerLiteral | int         | `123` or `1e2` <!-- md:liquid2 -->                                                             |
| FloatLiteral   | float       | `1.23` or `1.2e3` <!-- md:liquid2 -->                                                          |
| StringLiteral  | str         | `"Hello"` or `'g\'day'` <!-- md:liquid2 --> or `#!liquid2 'Hello, ${you}'` <!-- md:liquid2 --> |
| RangeLiteral   |             | `(1..5)` or `(x..y)`                                                                           |
| ArrayLiteral   |             | `var, 1, 2, 3` <!-- md:liquid2 -->                                                             |
...
When [`StrictUndefined`](api/undefined.md#liquid2.undefined.StrictUndefined) is passed as the `undefined` argument to an [`Environment`](api/environment.md), any operation on an undefined variable will raise an `UndefinedError`.
...
[`FalsyStrictUndefined`](api/undefined.md#liquid2.undefined.FalsyStrictUndefined) is the same as [`StrictUndefined`](#strict-undefined), but can be tested for truthiness and equality without raising an exception.
